...
data = pd.read_table('feature_all.txt',header=None,delim_whitespace=True)
#print(data)
x = data.iloc[:,1:]
print(x)
y = data.iloc[:,0]
...
# e = sum(((y_test_pred3 - y_test) / y_test) ** 2) ** 0.5
# print(e)
